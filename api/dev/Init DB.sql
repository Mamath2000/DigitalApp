...
INSERT INTO `linesdef` VALUES 
    ...
    (20,'MENS','CHARGE_PERSO','CHARGES DE PERSONNEL','',699,1,'[CHARGE_PERSO_FIXE]+[CHARGE_PERSO_VAR]+[INTERESS]','2099-12-31 00:00:00',1,1,0,0),
    (21,'MENS','TRESO','E.B.E. APPROCHÉ*','',999,1,'[PROD_TOTAL]-([ACHAT_FO]+[CHARGE_EXT]+[TAXES]+[CHARGE_PERSO])','2099-12-31 00:00:00',1,1,0,0);
